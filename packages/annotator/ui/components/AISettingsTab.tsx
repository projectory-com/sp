    ...
    return (
      <>
        ...
        <div className="flex items-start gap-2 p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg text-xs text-amber-600 dark:text-amber-400">
          ...
          <span>No AI providers detected. Install the <strong>claude</strong> or <strong>codex</strong> CLI and make sure you're authenticated.</span>
        </div>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div className="text-[10px] text-muted-foreground/70">
        Providers are detected from installed CLI tools. No API keys are managed -- you must be authenticated with each CLI independently.
      </div>
    </>
  );
};
