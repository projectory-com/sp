...
/**
 * Core types for the AI provider layer.
 *
 * This module defines the abstract interfaces that any agent runtime
 * (Claude Agent SDK, future providers) must implement to power AI
 * features inside the annotator's plan review and code review UIs.
 */
...
/**
 * An AI provider implements the bridge between the annotator and a specific
 ...
 * host environment (Claude Code -> "claude-agent-sdk").
 */
export interface AIProvider {
   ...
   * receives the review context. This enables the user to ask contextual
   * questions like "why did you change this function?" without the AI
   * losing insight.
   *
  ...
  /**
   * Resume a previously created AI session by its ID.
