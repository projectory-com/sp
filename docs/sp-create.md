...
Локальный скилл — доступен при разработке в репозитории sp (`.claude/skills/sp-create/`), не входит в публикуемый плагин.
...
Совместно с `/sp:sp-release` формирует цикл разработки плагина: sp-create создаёт, sp-release публикует.
