...
Если вопросы без отмеченных чекбоксов остались — сообщи пользователю и остановись:
«В плане остались неотвеченные вопросы. Ответьте на них в файле перед запуском.»
