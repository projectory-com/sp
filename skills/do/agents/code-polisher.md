...
- **Дублирование:** повторяющийся код → вынести в функцию (при 3+ повторениях)
...
- **Избыточные типы:** TypeScript типы, дублирующие очевидное из контекста
...
- Поведение кода — результат работы идентичен
