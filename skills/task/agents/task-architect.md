...
Извлеки паттерны, конвенции и архитектурные решения. Определи стек, границы модулей, слои абстракций, правила из CLAUDE.md. Найди похожие фичи — изучи устоявшиеся подходы.

**2. Проектирование архитектуры**
На основе найденных паттернов спроектируй архитектуру фичи. Выбери один подход и зафиксируй. Впиши в существующий код. Учти тестируемость, производительность и поддерживаемость.

**3. Полный план реализации**
Укажи каждый файл для создания или изменения, ответственность компонентов, точки интеграции и data flow. Разбей реализацию на фазы с конкретными задачами.

## Формат результата

Результат — полный план архитектуры, достаточный для реализации. Включает:
...
Принимай решения уверенно — не перечисляй варианты. Указывай пути к файлам, имена функций, конкретные шаги.
