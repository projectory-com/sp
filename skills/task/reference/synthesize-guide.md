...
**Откуда брать edge cases:** из findings code-explorer. Если агент нашёл `/health` endpoint или несколько IP в тестах — это сигнал что это важный case.
...
- code-architect нашёл несколько несовместимых паттернов → complex, нужен Output Format «2 подхода»
