...
- Нет слишком мелких задач: "создай файл" + "добавь импорт"
- Нет слишком крупных: "весь backend"
...
- Конкретные шаги, не "добавь валидацию"
...
Будь строгим, но справедливым. Фокусируйся на проблемах, влияющих на качество реализации.
