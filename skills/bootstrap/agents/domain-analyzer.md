...
Проанализируй доменную область проекта и верни structured report.
...
Прочитай найденные файлы (до 10). Извлеки:
...
Прочитай до 5 наиболее значимых файлов. Извлеки:
...
Прочитай top-5 результатов с контекстом (строка + 2 строки вокруг). Извлеки:
