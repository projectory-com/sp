...
3. Не трогай секции, к которым issues не относятся

## Правила

- Пользовательский контент не трогай — секции, добавленные вручную, сохраняй при обновлении
- Не добавляй generic advice ("write clean code", "follow best practices")
