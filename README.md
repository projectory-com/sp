...
Детектирует стек проекта, анализирует архитектуру, сканирует конвенции, генерирует CLAUDE.md и `.claude/sp-context.md`. Точка входа для подключения sp к новому проекту.
