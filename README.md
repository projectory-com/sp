...
Интерактивный инструмент для аннотирования планов и code review. Форк [plannotator](https://github.com/backnotprop/plannotator), адаптированный как standalone CLI для sp.
...
pnpm install
bun run build          # собрать все приложения + CLI binary
```

Три режима работы:

- **annotate** -- аннотирование markdown-файла (план, задача) с комментариями и рисунками
- **review** -- интерактивный code review текущих изменений или PR
- **diff** -- визуальный просмотр diff с подсветкой и навигацией

Документация: [архитектура](docs/annotator/architecture.md) | [сборка](docs/annotator/build.md) | [API](docs/annotator/api.md) | [синхронизация с upstream](docs/annotator/sync-guide.md)
